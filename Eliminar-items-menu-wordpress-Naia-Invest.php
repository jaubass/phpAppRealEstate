...
*/
    ...
    function my_remove_menu_pages() {
        ...
        remove_menu_page('admin.php?page=login-customizer');
        remove_menu_page('admin.php?page=wpforms');
        remove_menu_page('admin.php?page=joinchat');
        remove_menu_page('admin.php?page=monsterinsights');
    }
?>