<?php
/*
Plugin Name: Conciertos Widget
Plugin URI: http://www.bububass.com
Version: 1.0
Author: Jaume Fite
*/
...
class gg_Tourdates_Widget extends WP_Widget {
	...
	function widget($args, $instance) {	
		...
		/* display the widget */
			...
			$newtab= get_post_meta($post->ID, 'gxg_newtab', true);
                ...
                <li class="tourwidget-item">                                
                        ...
                        <div class="tourright">
                                ...
                                <div class="tour-url-w">  
                                        ...
                                        ?>                                        
                                        <a href="<?php echo $url; ?>" class="button2 tour-button" <?php if ($newtab) { echo "target='_blank' "; } ?> ><?php if ($button_text) { echo $button_text; } else { _e('Buy Tickets', 'gxg_textdomain'); } ?></a>     
                                        <?php
                                        }                                                        
                                        ?>
                                </div><!-- .buyticket -->        
